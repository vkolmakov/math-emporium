...
const collectData = () =>
    new Promise(async (resolve, reject) => {
        ...
        const extractLocation = createExtractDataValuesFunction([
            "id",
            "name",
            "calendarId",
            "isActive",
        ]);
        const extractCourse = createExtractDataValuesFunction([
            "id",
            "name",
            "code",
            "color",
        ]);
        const extractTutor = createExtractDataValuesFunction([
            "id",
            "name",
            "courses",
        ]);
        const extractSchedule = createExtractDataValuesFunction([
            "id",
            "weekday",
            "time",
            "tutors",
