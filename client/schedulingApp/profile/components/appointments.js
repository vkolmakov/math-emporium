...
const ConfirmationModal = ({ isOpen, onClose, onConfirm }) => (
    <Modal
        ...
        <div className="buttons-input-group-wrap">
            <button onClick={onClose} className="button-request-close">
                No
            </button>
...
class Appointments extends Component {
    ...
    deleteSelectedAppointment() {
        ...
        return deleteAppointment(appointmentToDelete).then(() => {
            this.setState({
                modalState: MODAL_STATE.MESSAGE,
                modalMessage: "Your appointment was successfully cancelled.",
            });
        });
    }
    ...
    render() {
        ...
        return (
            <div className="appointments">
                <h2>Appointments</h2>
                <AppointmentsOrMessage />
                <MaybeModal modalState={this.state.modalState} />
            </div>
        );
    }
}
