...
const navLinkConstructor = (currentRouterPath) => ({
    to,
    className,
    children,
    testId,
    ...
    return (
        <Link
            ...
            className={createClassName([
                "nav-link",
                className,
                isSelected(currentRouterPath, to) ? "selected" : "",
            ])}>
            {text}
        </Link>
    );
        ...
        if (this.props.authenticated) {
            switch (this.props.authGroup) {
                ...
                case AUTH_GROUPS.employer:
                    links = [
                        { to: "/edit-schedule", children: "Edit-schedule" },
            ...
            ? [
                  {
                      to: "/auth/signout",
                      className: "auth-link",
                      children: `Sign out (${this.props.email})`,
                      testId: TEST_ID.SIGNOUT_LINK,
                  },
              ]
            : [
                  {
