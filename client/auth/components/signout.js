              ...
              <div className="wrap">
                <div className="auth-content-wrap">
                  <div className="signout-message">
                    <h1>Goodbye!</h1>
                    <p>We will redirect you to sign out of your school account in a moment...</p>
                    <p>You can also click <a href={OAUTH2_PROVIDER_SIGNOUT_URL}>here</a> to sign out of your school account right away.</p>
                  </div>
                </div>
              </div>
            </MainContentWrap>
