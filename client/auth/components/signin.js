...
class Signin extends Component {
    ...
    initiateSignin() {
        ...
        this.setState(() => ({
            initiated: true,
            buttonWidthBeforeInitialization,
        }));
    ...
    render() {
        ...
        const AuthButton = () => (
            <button
                ...
                <div className="oauth2-button-content">
                    <img
                        className="oauth2-button-content-logo"
                        alt="School Logo"
                        src={schoolLogo}
                    />
                    <span className="oauth2-button-content-text">
        ...
        const AuthOrSpinnerButton = this.state.initiated
            ? SpinnerButton
            : AuthButton;
